let t;function e(t,e,o,a){Object.defineProperty(t,e,{get:o,set:a,enumerable:!0,configurable:!0})}function o(t){return t&&t.__esModule?t.default:t}var a="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},i={},s={},l=a.parcelRequired7c6;null==l&&((l=function(t){if(t in i)return i[t].exports;if(t in s){var e=s[t];delete s[t];var o={id:t,exports:{}};return i[t]=o,e.call(o.exports,o,o.exports),o.exports}var a=Error("Cannot find module '"+t+"'");throw a.code="MODULE_NOT_FOUND",a}).register=function(t,e){s[t]=e},a.parcelRequired7c6=l),l.register("kyEFX",function(t,o){"use strict";e(t.exports,"register",function(){return a},function(t){return a=t}),e(t.exports,"resolve",function(){return i},function(t){return i=t});var a,i,s={};a=function(t){for(var e=Object.keys(t),o=0;o<e.length;o++)s[e[o]]=t[e[o]]},i=function(t){var e=s[t];if(null==e)throw Error("Could not resolve bundle with id "+t);return e}}),l("kyEFX").register(JSON.parse('{"5ZPII":"index.f94133e0.js","1yVwl":"amazon.40ba9165.png","fIBw5":"book.89e7d427.png","fSsri":"book-block.950d06ef.png","fISP1":"shopinglist.2d9a977d.js","hh9YY":"shopinglist.b7026bad.js"}')),l("bUb57"),l("ghT7p");var n=l("2shzp");const r=document.querySelector(".container-books");async function c(){try{var t;let e;let o=await (0,n.default).get("https://books-backend.p.goit.global/books/top-books ");r.insertAdjacentHTML("beforeend",(t=o.data,e="",t.forEach(t=>{e+=`<div class="category-block">
    ...
    `;_.insertAdjacentHTML("beforeend",e);let o=document.querySelector(".button.book");JSON.parse(localStorage.getItem("userLogin"))||(o.disabled=!0,o.textContent="Login please"),o.addEventListener("click",e=>{w(t),S()})}}(t)}catch(t){console.error(t)}}async function w(t){try{let e=await L(t),{_id:o,book_image:a,title:i,list_name:s,description:l,author:n,buy_links:r}=e[0],c=JSON.parse(localStorage.getItem("savedBooks"))||[];c.push({_id:o,book_image:a,title:i,list_name:s,description:l,author:n,buy_links:r}),localStorage.setItem("savedBooks",JSON.stringify(c))}catch(t){console.error(t)}}!function(){let t=JSON.parse(localStorage.getItem("savedBooks"));t||localStorage.setItem("savedBooks",JSON.stringify([]))}(),window.addEventListener("load",function(){r.addEventListener("click",t=>{let e;"BUTTON"===t.target.tagName&&m(t.target.dataset.catname),t.target.classList.value.includes("js-ct")&&(e=t.target.parentElement.dataset.id),e&&($(e),v.classList.add("active"),h.classList.add("active"),document.body.style.overflow="hidden",v.addEventListener("click",t=>{t.target===v&&S()}),document.addEventListener("keydown",t=>{"Escape"===t.key&&S()}),y.addEventListener("click",t=>{S()}))})}),l("1MnFF"),l("gjiCh"),l("h8wPa");
//# sourceMappingURL=index.f94133e0.js.map
