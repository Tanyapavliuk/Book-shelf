let t;function e(t,e,o,i){Object.defineProperty(t,e,{get:o,set:i,enumerable:!0,configurable:!0})}function o(t){return t&&t.__esModule?t.default:t}var i="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},a={},s={},n=i.parcelRequired7c6;null==n&&((n=function(t){if(t in a)return a[t].exports;if(t in s){var e=s[t];delete s[t];var o={id:t,exports:{}};return a[t]=o,e.call(o.exports,o,o.exports),o.exports}var i=Error("Cannot find module '"+t+"'");throw i.code="MODULE_NOT_FOUND",i}).register=function(t,e){s[t]=e},i.parcelRequired7c6=n),n.register("kyEFX",function(t,o){"use strict";e(t.exports,"register",function(){return i},function(t){return i=t}),e(t.exports,"resolve",function(){return a},function(t){return a=t});var i,a,s={};i=function(t){for(var e=Object.keys(t),o=0;o<e.length;o++)s[e[o]]=t[e[o]]},a=function(t){var e=s[t];if(null==e)throw Error("Could not resolve bundle with id "+t);return e}}),n("kyEFX").register(JSON.parse('{"5ZPII":"index.30f9201c.js","1yVwl":"amazon.40ba9165.png","fIBw5":"book.89e7d427.png","fSsri":"book-block.950d06ef.png","1Z9FU":"shopinglist.4b9cc4e3.js","9RmGO":"shopinglist.761b46d9.js"}')),n("bUb57"),n("ghT7p");var l=n("2shzp"),r=n("iQIUW");const c=document.querySelector(".container-books");async function d(){try{var t;let e;let o=await (0,l.default).get("https://books-backend.p.goit.global/books/top-books ");c.insertAdjacentHTML("beforeend",(t=o.data,e="",t.forEach(t=>{e+=`<div class="category-block">
    ...
    <p class="book-author js-ct"> ${t}</p>
     ...
     `;c.innerHTML=e;let o=document.querySelector(".main-title"),i=o.textContent,a=i.split(" "),s=a[a.length-1];o.innerHTML=i.replace(s,`<span class="brendcolor">${s}</span>`)})(t))}m.addEventListener("click",function(t){let e=t.target.dataset.catname,o=Array.from(u.querySelectorAll("li")),i=o.find(t=>t.innerText===e),a=o.find(t=>"all categories"===t.innerText.toLowerCase());i&&(a.classList.remove("categories__title-active"),i.classList.add("categories__title-active"))}),u.addEventListener("click",function(t){let e=t.target,o=document.querySelector(".categories__title-active");if("LI"===e.tagName){if(o&&o.classList.remove("categories__title-active"),t.target.classList.add("categories__title-active"),"All Categories"===e.textContent.trim())return c.innerHTML="",d();b(e.textContent.trim())}}),f(),n("dTazW");var p={};p=new URL(n("kyEFX").resolve("1yVwl"),import.meta.url).toString();var v={};v=new URL(n("kyEFX").resolve("fIBw5"),import.meta.url).toString();var k={};k=new URL(n("kyEFX").resolve("fSsri"),import.meta.url).toString();var r=n("iQIUW");const y=document.querySelector(".backdrop"),h=document.querySelector(".modal"),S=document.querySelector(".modal-shopping-close"),_=document.querySelector(".render-modal"),L=document.querySelector(".scroll-btn");function w(){y.classList.remove("active"),h.classList.remove("active"),L.classList.remove("visually-hidden"),document.body.style.overflow="auto"}async function $(t){try{let e=`https://books-backend.p.goit.global/books/${t}`,o=await fetch(e);if(!o.ok)throw Error(`Error: ${o.status} ${o.statusText}`);let i=await o.json();return[i]}catch(t){(0,r.Notify).warning("Sorry, failed to load information")}}const E=()=>{let t=document.querySelector(".darkFilterModal");"dark"===localStorage.getItem("theme")?t.classList.add("filter-img"):t.classList.remove("filter-img")};async function j(e){try{L.classList.add("visually-hidden"),_.innerHTML="";let i=await $(e);t=i[0]._id,function(t){let e=t.map(t=>`
        ...
        `).join("");_.insertAdjacentHTML("beforeend",e)}(i),E(),function(t){let e=JSON.parse(localStorage.getItem("savedBooks"));if(e.some(e=>e._id===t)){let t=`
